...
<div style="display: flex; justify-content: center;">
  <img src="/assets/images/overview-swarm1.png" alt="system overview" style="width: 50%; max-width: 1000px; height: auto; border-radius: 5px;">
</div>
...
<div style="display: flex; justify-content: center; width: 100%;">
  <figure style="margin: 0; text-align: center; display: flex; flex-direction: column; align-items: center;">
    <img src="/assets/images/coachbot_diag1.png"
         alt="Coachbot system overview"
         style="width: 95%; max-width: 300px; height: auto; border-radius: 5px; filter: grayscale(100%);">
    <figcaption style="font-size: 0.8rem; color: #666; margin-top: 4px;">
      Coachbot system illustration created in collaboration with ChatGPT.
    </figcaption>
  </figure>
</div>
...
<div style="display: flex; justify-content: center;">
  <img src="/assets/images/all_gestures_gif.gif" alt="laban efforts" style="width: 75%; max-width: 1000px; height: auto; border-radius: 5px;">
</div>
...
<div style="display: flex; justify-content: center;">
  <img src="/assets/images/shapes1.png" alt="laban efforts" style="width: 50%; max-width: 1000px; height: auto; border-radius: 5px;">
</div>
...
<div class="gallery" data-columns="1" data-carousel-interval="8000">
   <img src="/assets/images/encricle-slide1.gif">
    <img src="/assets/images/float-slide1.gif">
    <img src="/assets/images/slash-slide1.gif">
</div>
...
## Github
**Swarm Control & Choreography Engine**  
  Random Forest–driven swarm algorithms for the CoachBot platform  
  [View on GitHub](https://github.com/m0therb0ardd/coachbot_swarm_dance_simulation)

**Laban Effort Gesture Classifier**  
  Random Forest classifier trained on embodied movement phrases  
  [View on GitHub](https://github.com/m0therb0ardd/laban_classifier/tree/improving)
